...
function PwiOptOut({ thread }: { thread: AppBskyFeedDefs.ThreadViewPost }) {
	...
	return (
		<Container href={href}>
			<Link href={href} className="transition-transform hover:scale-110 absolute top-4 right-4">
...
function ErrorMessage() {
	return (
		<Container href="https://bsky.app/">
			<Link href="https://bsky.app/" className="transition-transform hover:scale-110 absolute top-4 right-4">
				<img src={logo} className="h-6" />
			</Link>
