...
export const PROD_FEEDS = [`feedgen|${PROD_DEFAULT_FEED("whats-hot")}`, `feedgen|${PROD_DEFAULT_FEED("thevids")}`];
...
export const STAGING_LINK_META_PROXY = "https://cardyb.staging.bsky.dev/v1/extract?url=";
...
// Hitslop constants
export const createHitslop = (size: number) => ({
	top: size,
	left: size,
	bottom: size,
	right: size,
...
export const STAGING_VIDEO_FEED_URI = "at://did:plc:yofh3kx63drvfljkibw5zuxo/app.bsky.feed.generator/thevids";
...
export const GIF_SEARCH = (params: string) => `${GIF_SERVICE}/tenor/v2/search?${params}`;
export const GIF_FEATURED = (params: string) => `${GIF_SERVICE}/tenor/v2/featured?${params}`;
...
export const SUPPORTED_MIME_TYPES = ["video/mp4", "video/mpeg", "video/webm", "video/quicktime", "image/gif"] as const;
