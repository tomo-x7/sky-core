...
export const LANGUAGES_MAP_CODE2 = Object.fromEntries(LANGUAGES.map((lang) => [lang.code2, lang]));

export const LANGUAGES_MAP_CODE3 = Object.fromEntries(LANGUAGES.map((lang) => [lang.code3, lang]));
