...
export function useComposerKeyboardShortcut() {
	...
	React.useEffect(() => {
		...
		function handler(event: KeyboardEvent) {
			...
			if (openDialogs?.current.size > 0 || isModalActive || activeLightbox || isDrawerOpen) return;
	...
	}, [openComposer, isModalActive, openDialogs, activeLightbox, isDrawerOpen, hasSession]);
}
