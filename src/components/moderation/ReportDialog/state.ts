	...
	switch (action.type) {
		case "selectOption":
			return {
				...
				activeStepIndex1: 2,
				detailsOpen: !!state.details || action.option.reason === ComAtprotoModerationDefs.REASONOTHER,
			};
		case "clearOption":
			return {
				...state,
				...
				selectedLabeler: undefined,
				activeStepIndex1: 1,
				detailsOpen: !!state.details || state.selectedOption?.reason === ComAtprotoModerationDefs.REASONOTHER,
			};
		case "selectLabeler":
			return {
				...state,
