...
export const IconTemplate_Stroke2_Corner0_Rounded = React.forwardRef<SVGSVGElement>(function LogoImpl(
	props: Props,
	ref,
) {
...
export function createSinglePathSVG({ path }: { path: string }) {
	return React.forwardRef<SVGSVGElement, Props>(function LogoImpl(props, ref) {
