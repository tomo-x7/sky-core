...
export function BackgroundNotificationPreferencesProvider({
	...
	const [preferences, setPreferences] = React.useState<BackgroundNotificationHandlerPreferences>({
		playSoundChat: true,
	});
	...
	const value = React.useMemo(
		() => ({
			preferences,
			setPref: async <Key extends keyof BackgroundNotificationHandlerPreferences>(
				k: Key,
