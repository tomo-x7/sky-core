...
export const RQKEY = (status: "accepted" | "request" | "all", readState: "all" | "unread" = "all") => [
	RQKEY_ROOT,
	status,
	readState,
];
	...
	return (
		convos
			...
			.reduce((acc, convo) => {
				...
				const shouldIgnore = convo.muted || moderation.blocked || otherMember.handle === "missing.invalid";
