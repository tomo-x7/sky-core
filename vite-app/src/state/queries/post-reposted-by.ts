import type { AppBskyActorDefs, AppBskyFeedGetRepostedBy } from "@atproto/api";
...
export function* findAllProfilesInQueryData(
	...
	const queryDatas = queryClient.getQueriesData<InfiniteData<AppBskyFeedGetRepostedBy.OutputSchema>>({
		queryKey: [RQKEY_ROOT],
	});
