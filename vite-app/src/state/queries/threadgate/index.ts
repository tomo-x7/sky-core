import { AppBskyFeedDefs, AppBskyFeedGetPostThread, AppBskyFeedThreadgate, AtUri, BskyAgent } from "@atproto/api";
...
export async function upsertThreadgate(
	...
	callback: (threadgate: AppBskyFeedThreadgate.Record | null) => Promise<AppBskyFeedThreadgate.Record | undefined>,
) {
			...
			await until(
				...
				(res: AppBskyFeedGetPostThread.Response) => {
					...
					if (AppBskyFeedDefs.isThreadViewPost(thread)) {
						const fetchedSettings = threadgateViewToAllowUISetting(thread.post.threadgate);
