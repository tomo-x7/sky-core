...
export function usePreferencesSetContentLabelMutation() {
	...
	return useMutation<void, unknown, { label: string; visibility: LabelPreference; labelerDid: string | undefined }>({
...
export function useSetActiveProgressGuideMutation() {
	...
	return useMutation({
		mutationFn: async (guide: AppBskyActorDefs.BskyAppProgressGuide | undefined) => {
