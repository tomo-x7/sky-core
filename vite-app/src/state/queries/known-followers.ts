import type { AppBskyActorDefs, AppBskyGraphGetKnownFollowers } from "@atproto/api";
...
export function* findAllProfilesInQueryData(
	...
	const queryDatas = queryClient.getQueriesData<InfiniteData<AppBskyGraphGetKnownFollowers.OutputSchema>>({
		queryKey: [RQKEY_ROOT],
	});
