import type { AppBskyActorDefs, AppBskyGraphGetMutes } from "@atproto/api";
...
export function* findAllProfilesInQueryData(
	...
	const queryDatas = queryClient.getQueriesData<InfiniteData<AppBskyGraphGetMutes.OutputSchema>>({
		queryKey: [RQKEY_ROOT],
	});
