...
export function mergePostgateRecords(prev: AppBskyFeedPostgate.Record, next: Partial<AppBskyFeedPostgate.Record>) {
...
export function createEmbedViewRecordFromPost(post: AppBskyFeedDefs.PostView): $Typed<AppBskyEmbedRecord.ViewRecord> {
	return {
