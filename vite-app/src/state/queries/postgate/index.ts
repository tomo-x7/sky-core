...
export async function upsertPostgate(
	...
	callback: (postgate: AppBskyFeedPostgate.Record | undefined) => Promise<AppBskyFeedPostgate.Record | undefined>,
) {
...
export function useToggleQuoteDetachmentMutation() {
	...
	const prevEmbed = React.useRef<AppBskyFeedDefs.PostView["embed"] | null>(null);
