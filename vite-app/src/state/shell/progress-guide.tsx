...
export function Provider({ children }: React.PropsWithChildren) {
	...
	const activeProgressGuide = useMemo(() => {
		...
		if (maybeWronglyTypedProgressGuide?.guide === "like-10-and-follow-7") {
			maybeWronglyTypedProgressGuide.numLikes = Number(maybeWronglyTypedProgressGuide.numLikes) || 0;
			maybeWronglyTypedProgressGuide.numFollows = Number(maybeWronglyTypedProgressGuide.numFollows) || 0;
