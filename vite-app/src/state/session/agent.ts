...
export function agentToSessionAccount(agent: BskyAgent): SessionAccount | undefined {
	if (!agent.session) {
		return undefined;
	}
	return {
...
export function sessionAccountToSession(account: SessionAccount): AtpSessionData {
	return {
