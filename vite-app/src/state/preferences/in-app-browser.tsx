...
const stateContext = React.createContext<StateContext>(persisted.defaults.useInAppBrowser);
const setContext = React.createContext<SetContext>((_: persisted.Schema["useInAppBrowser"]) => {});
