...
type SetStateCb = (s: persisted.Schema["hiddenPosts"]) => persisted.Schema["hiddenPosts"];
...
const stateContext = React.createContext<StateContext>(persisted.defaults.hiddenPosts);
