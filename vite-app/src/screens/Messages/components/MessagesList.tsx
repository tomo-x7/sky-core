...
import { $Typed, AppBskyEmbedRecord, AppBskyRichtextFacet, RichText } from "@atproto/api";
...
import { EmojiPicker, EmojiPickerState } from "#/view/com/composer/text-input/web/EmojiPicker.web";
...
export function MessagesList({
	...
	const [emojiPickerState, setEmojiPickerState] = React.useState<EmojiPickerState>({
		isOpen: false,
