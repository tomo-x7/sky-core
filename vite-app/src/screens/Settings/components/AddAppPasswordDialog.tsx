	...
	const regexFailError = useMemo(
		() =>
			new DisplayableError(
				_(msg`App password names can only contain letters, numbers, spaces, dashes, and underscores`),
			),
		[_],
	);
				...
				<LayoutAnimationConfig skipEntering skipExiting>
					{!data ? (
									...
									(error && !(error instanceof DisplayableError) && (
										<Animated.View entering={FadeIn} exiting={FadeOut}>
											<Admonition type="error">
												<Trans>Failed to create app password. Please try again.</Trans>
											</Admonition>
										</Animated.View>
									))}
							</Animated.View>
						...
						<Animated.View style={[a.gap_lg]} entering={isWeb ? FadeIn.delay(200) : SlideInRight} key={1}>
							...
							<Text style={[a.text_md, a.leading_snug]}>
								<Trans>Use this to sign in to the other app along with your handle.</Trans>
							</Text>
							<CopyButton
								value={data.password}
