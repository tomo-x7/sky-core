		...
		<View style={[a.relative]}>
			{hasBeenCopied && (
				<Animated.View
					...
					pointerEvents="none"
				>
					<Text style={[a.font_bold, a.text_right, a.text_md, t.atoms.text_contrast_high]}>Copied!</Text>
				</Animated.View>
			)}
			<Button style={[a.flex_1, a.justify_between, style]} onPress={onPress} {...props} />
		</View>
	);
}
