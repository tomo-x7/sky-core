		...
		<Layout.Screen>
			<Layout.Header.Outer>
				...
				<Layout.Header.Content>
					<Layout.Header.TitleText>App Icon</Layout.Header.TitleText>
				</Layout.Header.Content>
				<Layout.Header.Slot />
			</Layout.Header.Outer>
...
function Group({
	...
	return (
		...
		>
			<View style={[a.flex_1, a.rounded_md, a.overflow_hidden]}>{children}</View>
		</Toggle.Group>
	);
}
...
function RowText({ children }: { children: React.ReactNode }) {
	const t = useTheme();
	return (
		<Text style={[a.text_md, a.font_bold, a.flex_1, t.atoms.text_contrast_medium]} emoji>
			{children}
		</Text>
	);
}
