...
export function CaptchaWebView({
	...
	const redirectHost = React.useMemo(() => {
		...
		return state?.serviceUrl && new URL(state?.serviceUrl).host === "staging.bsky.dev"
			? "staging.bsky.app"
			: "bsky.app";
	}, [state?.serviceUrl]);
	...
	const onShouldStartLoadWithRequest = React.useCallback((event: ShouldStartLoadRequest) => {
