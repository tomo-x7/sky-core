...
import { AppBskyGraphDefs, AppBskyGraphStarterpack, AtUri, ModerationOpts } from "@atproto/api";
...
export function LandingScreen({
	...
	if (!bsky.dangerousIsType<AppBskyGraphStarterpack.Record>(starterPack.record, AppBskyGraphStarterpack.isRecord)) {
		return null;
	}
