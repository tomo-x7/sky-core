...
import { ActivityIndicator, Keyboard, LayoutAnimation, TextInput, View } from "react-native";
import { ComAtprotoServerCreateSession, ComAtprotoServerDescribeServer } from "@atproto/api";
				...
				<View style={[a.gap_sm]}>
					<TextField.Root>
						...
						<TextField.Input
							...
							accessibilityHint={_(msg`Input the username or email address you used at signup`)}
						/>
					</TextField.Root>
				...
				<View>
					...
					<TextField.Root>
						...
						<TextField.Input
							...
							onSubmitEditing={onPressNext}
							editable={!isProcessing}
							accessibilityHint={_(msg`Input the code which has been emailed to you`)}
							style={[
								{
