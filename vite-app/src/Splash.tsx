...
export const Logo = React.forwardRef<SVGSVGElement, React.SVGProps<SVGSVGElement>>(function LogoImpl(props, ref) {
	const width = 1000;
	const height = width * (67 / 64);
	return (
		<svg fill="none" ref={ref} viewBox="0 0 64 66" style={{ width, height, ...props.style }}>
			<path
				fill={props.fill || "#fff"}
