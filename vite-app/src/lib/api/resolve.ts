...
export async function resolveGif(agent: BskyAgent, gif: Gif): Promise<ResolvedExternalLink> {
...
async function resolveExternal(agent: BskyAgent, uri: string): Promise<ResolvedExternalLink> {
...
async function imageToThumb(imageUri: string): Promise<ComposerImage | undefined> {
	try {
