...
export const IS_INTERNAL = false; //__DEV__;
...
export const BUNDLE_IDENTIFIER = ""; //process.env.EXPO_PUBLIC_BUNDLE_IDENTIFIER ?? "dev";
...
export const BUNDLE_DATE = 0; //__DEV__ ? 0 : Number(process.env.EXPO_PUBLIC_BUNDLE_DATE);
