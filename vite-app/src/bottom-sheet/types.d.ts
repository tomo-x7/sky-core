...
import type { FlatList, NativeScrollEvent, NativeSyntheticEvent, ScrollView, SectionList } from "react-native";
...
export type ScrollableEvent = (event: Pick<NativeSyntheticEvent<NativeScrollEvent>, "nativeEvent">) => void;
//#endregion
...
//#region hooks
export type GestureEventPayloadType = GestureEventPayload & PanGestureHandlerEventPayload;
