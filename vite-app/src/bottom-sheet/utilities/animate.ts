...
export const animate = ({ point, configs = undefined, velocity = 0, onComplete }: AnimateParams) => {
	"worklet";
	...
	if (type === ANIMATION_METHOD.TIMING) {
		...
		return withSpring(point, Object.assign({ velocity }, configs) as WithSpringConfig, onComplete);
	}
};
