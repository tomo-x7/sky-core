...
import type { AnimateStyle, SharedValue, WithSpringConfig, WithTimingConfig } from "react-native-reanimated";
import type { ANIMATION_SOURCE, KEYBOARD_BEHAVIOR, KEYBOARD_BLUR_BEHAVIOR, KEYBOARD_INPUT_MODE } from "../../constants";
...
export interface BottomSheetProps
	extends BottomSheetAnimationConfigs,
		Partial<
			Pick<
				...
				"activeOffsetY" | "activeOffsetX" | "failOffsetY" | "failOffsetX" | "waitFor" | "simultaneousHandlers"
			>
		> {
	 ...
	 */
	onAnimate?: (fromIndex: number, toIndex: number, source: ANIMATION_SOURCE) => void;
	//#endregion
