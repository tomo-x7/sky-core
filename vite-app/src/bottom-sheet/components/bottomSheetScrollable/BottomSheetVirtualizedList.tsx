...
const AnimatedVirtualizedList = Animated.createAnimatedComponent<RNVirtualizedListProps<any>>(RNVirtualizedList);

const BottomSheetVirtualizedListComponent = createBottomSheetScrollableComponent<
