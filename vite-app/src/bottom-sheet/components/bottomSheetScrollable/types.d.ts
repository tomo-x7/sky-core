...
import type { DependencyList, EffectCallback, ReactNode, Ref, RefObject } from "react";
import type {
	FlatListProps,
	NodeHandle,
...
export type ScrollableProps<T> = ScrollViewProps | FlatListProps<T> | FlashListProps<T> | SectionListProps<T>;
