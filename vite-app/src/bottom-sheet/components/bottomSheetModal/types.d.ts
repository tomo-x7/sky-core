...
export interface BottomSheetModalProps extends Omit<BottomSheetProps, "containerHeight" | "onClose"> {
	/**
	 ...
	 */
	children: (({ data: any }?) => React.ReactElement) | React.ReactNode[] | React.ReactNode;
}
