...
import type { BottomSheetModalProviderProps, BottomSheetModalRef } from "./types";

const BottomSheetModalProviderWrapper = ({ children }: BottomSheetModalProviderProps) => {
	...
	const handleMountSheet = useCallback((key: string, ref: any, stackBehavior: BottomSheetModalStackBehavior) => {
