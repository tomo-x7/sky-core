...
export function NuxDialogs() {
	...
	return !isLoading ? (
		<Inner currentAccount={currentAccount} currentProfile={profile} preferences={preferences} />
	) : null;
}
...
function Inner({
	...
	React.useEffect(() => {
		...
		for (const { id, enabled } of queuedNuxs) {
			...
			saveNux({
				...
				console.error(`NUX dialogs: failed to upsert '${id}' NUX`, {
	...
	}, [nuxs, snoozed, snoozeNuxDialog, saveNux, gate, currentAccount, currentProfile, preferences]);
