export const SCROLLBAR_OFFSET = "calc(-1 * var(--removed-body-scroll-bar-size, 0px) / 2)" as any;
export const SCROLLBAR_OFFSET_POSITIVE = "calc(var(--removed-body-scroll-bar-size, 0px) / 2)" as any;
