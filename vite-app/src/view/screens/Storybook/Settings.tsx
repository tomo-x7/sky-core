...
export function Settings() {
	...
	return (
		<View style={{ marginLeft: -20, marginRight: -20 }}>
			...
			<SettingsList.LinkItem to="/settings" label="Accessibility and appearance">
				<SettingsList.ItemIcon icon={PaintRollerIcon} />
				<SettingsList.ItemText>Accessibilty and appearance</SettingsList.ItemText>
			</SettingsList.LinkItem>
			...
			<SettingsList.PressableItem onPress={() => Toast.show("Pressable pressed")} label="Pressable">
				<SettingsList.ItemIcon icon={AlienIcon} />
				<SettingsList.ItemText>Pressable</SettingsList.ItemText>
			</SettingsList.PressableItem>
			<SettingsList.LinkItem to="/settings" label="Destructive link" destructive>
			...
			<SettingsList.PressableItem
				...
				style={[a.my_sm, a.mx_lg, a.rounded_md, { backgroundColor: t.palette.primary_50 }]}
			...
			<SettingsList.Item>
				...
				<SettingsList.BadgeButton label="Edit" onPress={() => Toast.show("Show edit birthday dialog")} />
			</SettingsList.Item>
