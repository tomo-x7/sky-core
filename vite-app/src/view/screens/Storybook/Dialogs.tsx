		...
		<View style={[a.gap_md]}>
			...
			<Prompt.Outer control={prompt}>
				...
				<Prompt.DescriptionText>
					This is a generic prompt component. It accepts a title and a description, as well as two actions.
				</Prompt.DescriptionText>
				<Prompt.Actions>
					<Prompt.Cancel />
			...
			<Dialog.Outer control={testDialog}>
				...
				>
					<View style={[a.relative, a.gap_md, a.w_full]}>
						...
						>
							<ButtonText>
								Calls `.open()` in 100ms (Should log when the animation switches to open)
							</ButtonText>
						</Button>
						...
						>
							<ButtonText>
								Calls `.open()` in 2000ms (Should log after close animation and not log on open)
							</ButtonText>
						</Button>
						...
						<Button
							...
							label="Close It"
						>
							<ButtonText>Calls `.close()` then again in 100ms (should log twice)</ButtonText>
						</Button>
						...
						<Button
							...
							label="Close It"
						>
							<ButtonText>Call `close()` twice immediately (should just log twice)</ButtonText>
						</Button>
						...
						>
							<ButtonText>
								Log before `close()`, after `close()` and in the `close()` callback. Should be an order
								of 1 2 3
							</ButtonText>
						</Button>
					</View>
