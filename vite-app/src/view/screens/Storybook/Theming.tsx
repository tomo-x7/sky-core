...
export function Theming() {
	...
	return (
		<View style={[t.atoms.bg, a.gap_lg, a.p_xl]}>
			...
			<Text style={[a.font_bold, t.atoms.text_contrast_high, a.px_md]}>theme.atoms.text_contrast_high</Text>

			<View style={[a.flex_1, t.atoms.border_contrast_medium, a.border_t]} />
			<Text style={[a.font_bold, t.atoms.text_contrast_medium, a.px_md]}>theme.atoms.text_contrast_medium</Text>

			<View style={[a.flex_1, t.atoms.border_contrast_low, a.border_t]} />
			<Text style={[a.font_bold, t.atoms.text_contrast_low, a.px_md]}>theme.atoms.text_contrast_low</Text>
