...
import { LayoutChangeEvent, NativeScrollEvent, ScrollView, StyleSheet, View } from "react-native";
import Animated, {
	AnimatedRef,
	runOnJS,
	runOnUI,
...
let PagerTabBar = ({
	...
	const headerTransform = useAnimatedStyle(() => {
		...
		return {
			transform: [
				{
					translateY: allowHeaderOverScroll ? translateY : Math.min(translateY, 0),
				},
			],
		};
	});
	...
	return (
		...
		>
			<View ref={headerRef} pointerEvents={isIOS ? "auto" : "box-none"} collapsable={false}>
