...
const ImageItem = ({
	...
	function getExtraTranslationToStayInBounds(
		...
		const clampedTranslateX = clampTranslation(nextTranslateX, scaledDimensions.width, screenSize.width);
		const clampedTranslateY = clampTranslation(nextTranslateY, scaledDimensions.height, screenSize.height);
	...
	const doubleTap = Gesture.Tap()
		...
		.onEnd((e) => {
			...
			const candidateScale = Math.max(imageAspect / screenAspect, screenAspect / imageAspect, MIN_SCREEN_ZOOM);
