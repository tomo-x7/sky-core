...
export type TransformMatrix = [number, number, number, number, number, number, number, number, number];
...
export function prependPinch(t: TransformMatrix, scale: number, origin: Position, translation: Position) {
	"worklet";
	prependTranslate(t, translation.x, translation.y);
