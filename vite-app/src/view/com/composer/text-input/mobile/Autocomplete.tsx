...
export function Autocomplete({
	...
	return (
		<Animated.View
			...
			style={[t.atoms.bg, a.mt_sm, a.border, a.rounded_sm, t.atoms.border_contrast_high, { marginLeft: -62 }]}
		>
			{suggestions?.length ? (
					...
					return (
						...
						>
							<PressableScale
								...
								style={[a.flex_row, a.gap_sm, a.justify_between, a.align_center]}
							...
							>
								<View style={[a.flex_row, a.gap_sm, a.align_center]}>
									...
									/>
									<Text style={[a.flex_1, a.text_md, a.font_bold]} emoji numberOfLines={1}>
										{sanitizeDisplayName(item.displayName || sanitizeHandle(item.handle))}
									</Text>
									<Text
										style={[t.atoms.text_contrast_medium, a.text_right, { maxWidth: "50%" }]}
										numberOfLines={1}
									>
