...
export function AviFollowButton({
	...
	const name = sanitizeDisplayName(profile.displayName || profile.handle, moderation.ui("displayName"));
	const isFollowing = profile.viewer?.following || profile.did === currentAccount?.did;
