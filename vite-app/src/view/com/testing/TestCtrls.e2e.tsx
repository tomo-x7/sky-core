...
export function TestCtrls() {
	...
	return (
		<View style={{ position: "absolute", top: 100, right: 0, zIndex: 100 }}>
			<Pressable testID="e2eSignInAlice" onPress={onPressSignInAlice} accessibilityRole="button" style={BTN} />
			<Pressable testID="e2eSignInBob" onPress={onPressSignInBob} accessibilityRole="button" style={BTN} />
			<Pressable
				testID="e2eSignOut"
				...
				style={BTN}
			/>
			<Pressable testID="e2eGotoHome" onPress={() => navigate("Home")} accessibilityRole="button" style={BTN} />
			<Pressable
			...
			<Pressable
				...
				style={BTN}
			/>
			<Pressable testID="e2eGotoLists" onPress={() => navigate("Lists")} accessibilityRole="button" style={BTN} />
			<Pressable testID="e2eGotoFeeds" onPress={() => navigate("Feeds")} accessibilityRole="button" style={BTN} />
			<Pressable
