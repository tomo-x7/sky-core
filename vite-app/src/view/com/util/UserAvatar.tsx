...
let DefaultAvatar = ({
	...
	if (type === "algo") {
		...
		return (
			<Svg testID="userAvatarFallback" width={size} height={size} viewBox="0 0 32 32" fill="none" stroke="none">
	...
	// TODO: shape=square
	return (
		<Svg testID="userAvatarFallback" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="none">
