...
export function ModalsContainer() {
	...
	if (snapPoints[0] === "fullscreen") {
		return <SafeAreaView style={[styles.fullscreenContainer, pal.view]}>{element}</SafeAreaView>;
	}
	...
	return (
		<Container>
			<BottomSheet
				...
				backdropComponent={isModalActive ? createCustomBackdrop(onClose) : undefined}
